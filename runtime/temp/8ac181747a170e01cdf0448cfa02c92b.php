<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"D:\Software\phpstudy\WWW\study\heber_o2o\public/../app/index\view\lists\index.html";i:1519050171;s:72:"D:\Software\phpstudy\WWW\study\heber_o2o\app\index\view\public\head.html";i:1518946999;s:71:"D:\Software\phpstudy\WWW\study\heber_o2o\app\index\view\public\nav.html";i:1518615084;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                        ...
                        <div class="normal-filter ">
                            <div class="w-filter-normal-ab  filter-list-ab">
                                ...
                                <span class="filter-all-ab">
                                    <a href="<?php echo url('lists/index'); ?>" class="w-filter-item-ab  item-all-auto-ab"><span class="item-content <?php if($parent_id == 0): ?>filter-active-all-ab <?php endif; ?>">全部</span></a>
                                </span>
                                <div class="j-filter-items-wrap-ab filter-items-wrap-ab">
                                    <div class="j-filter-items-ab filter-items-ab filter-content-ab">
                                        <?php if(is_array($firstCategorys) || $firstCategorys instanceof \think\Collection || $firstCategorys instanceof \think\Paginator): $i = 0; $__LIST__ = $firstCategorys;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                        <a href="<?php echo url('lists/index',['id'=>$vo['id']]); ?>" class="w-filter-item-ab"><span class="item-content <?php if($parent_id == $vo['id']): ?>filter-active-all-ab <?php endif; ?>"><?php echo $vo['name']; ?></span></a>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="filter-wrapper">
                        <div class="normal-filter ">
                            <div class="w-filter-normal-ab  filter-list-ab">
                                ...
                                <div class="j-filter-items-wrap-ab filter-items-wrap-ab">
                                    <div class="j-filter-items-ab filter-items-ab filter-content-ab">
                                        <?php if(is_array($secondCategorys) || $secondCategorys instanceof \think\Collection || $secondCategorys instanceof \think\Paginator): $i = 0; $__LIST__ = $secondCategorys;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                        <a href="<?php echo url('lists/index',['id'=>$vo['id']]); ?>" class="w-filter-item-ab"><span class="item-content <?php if($se_id == $vo['id']): ?>filter-active-all-ab <?php endif; ?>"><?php echo $vo['name']; ?></span></a>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                    </div>
                                </div>
                ...
                <div class="w-sort-bar">
                    <div class="bar-area" style="position: relative; left: 0px; margin-left: 0px; margin-right: 0px; margin-top: 0px; top: 0px;">
                        <span class="sort-area">
                            <a class="sort-default <?php if($order_flag == ""): ?>  sort-default-active <?php endif; ?>">默认</a>
                            <a href="<?php echo url('lists/index',['id'=>$id,'order_sales'=>1]); ?>" class="sort-item sort-down <?php if($order_flag == "order_sales"): ?>  sort-default-active <?php endif; ?>" title="点击按销量降序排序">销量↓</a>
                            <a href="<?php echo url('lists/index',['id'=>$id,'order_price'=>1]); ?>" class="sort-item price-default price <?php if($order_flag == "order_price"): ?>  sort-default-active <?php endif; ?>" title="点击按价格降序排序">价格↓</a>
                            
                            <a href="<?php echo url('lists/index',['id'=>$id,'order_time'=>1]); ?>" class="sort-item sort-up <?php if($order_flag == "order_time"): ?>  sort-default-active <?php endif; ?>" title="发布时间由近到远">最新发布↑</a>
                        </span>
