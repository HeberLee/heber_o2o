                ...
                <div class="floor-content-start">
                    ...
                    <div class="floor-content">
                        <div class="floor-header">
                            ...
                            <ul class="reco-words">
                                <li><a href="//t10.nuomi.com/pc/t10/index" target="_blank">精选</a></li>
                                <?php if(is_array($food_cates) || $food_cates instanceof \think\Collection || $food_cates instanceof \think\Paginator): $i = 0; $__LIST__ = $food_cates;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?>
                                <li><a href="//bj.nuomi.com/380" target="_blank"><?php echo $cate['name']; ?></a></li>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
